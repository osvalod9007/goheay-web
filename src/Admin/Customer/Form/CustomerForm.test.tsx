...
describe('Test Customer Form Component', () => {
  ...
  it('Should render Customer Form component', () => {
  ...
  it('Should save Snapshot for Customer Form component', () => {
    act(() => {
      const app = render(
        <ApolloProvider client={client}>
          <I18nextProvider i18n={i18n}>
  ...
  it('Should modify field for Customer Form component', () => {
    act(() => {
      render(
        <ApolloProvider client={client}>
          <I18nextProvider i18n={i18n}>
