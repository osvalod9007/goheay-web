...
import FleetOwnerForm from './FleetOwnerForm';
...
describe('Test Fleet Owner Form Component', () => {
  ...
  it('Should render Fleet Owner Form component', () => {
  ...
  it('Should save Snapshot for Fleet Owner Form component', () => {
    act(() => {
      const app = render(
        <ApolloProvider client={client}>
          <I18nextProvider i18n={i18n}>
  ...
  it('Should modify field for Fleet Owner Form component', () => {
    act(() => {
      render(
        <ApolloProvider client={client}>
          <I18nextProvider i18n={i18n}>
