...
describe('Test StepThree Form Component', () => {
  ...
  it('Should render StepThree Form component', () => {
  ...
  it('Should save Snapshot for StepThree Form component', () => {
    act(() => {
      const app = render(
        <ApolloProvider client={client}>
          <I18nextProvider i18n={i18n}>
  ...
  it('Should modify field for StepThree Form component', () => {
    act(() => {
      render(
        <ApolloProvider client={client}>
          <I18nextProvider i18n={i18n}>
    ...
    const input: any = document.getElementById('insuranceRenewal');
