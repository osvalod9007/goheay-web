...
describe('Test StepOne Form Component', () => {
  ...
  it('Should render StepOne Form component', () => {
  ...
  it('Should save Snapshot for StepOne Form component', () => {
    act(() => {
      const app = render(
        <ApolloProvider client={client}>
          <I18nextProvider i18n={i18n}>
  ...
  it('Should modify field for StepOne Form component', () => {
    act(() => {
      render(
        <ApolloProvider client={client}>
          <I18nextProvider i18n={i18n}>
    ...
    const input: any = document.getElementById('payload');
