...
describe('Test Driver Form Component', () => {
  ...
  it('Should render Driver Form component', () => {
  ...
  it('Should save Snapshot for Driver Form component', () => {
    act(() => {
      const app = render(
        <ApolloProvider client={client}>
          <I18nextProvider i18n={i18n}>
  ...
  it('Should modify field for Driver Form component', () => {
    act(() => {
      render(
        <ApolloProvider client={client}>
          <I18nextProvider i18n={i18n}>
